...
function __kortext_class_element(str) constructor
{
	...
	static input = function(str)
	{
		...
		str = string_replace_all(str,"ㅂ","q");
		str = string_replace_all(str,"ㅃ","Q");
	
		str = string_replace_all(str,"ㅈ","w");
		str = string_replace_all(str,"ㅉ","W");
	
		str = string_replace_all(str,"ㄷ","e");
		str = string_replace_all(str,"ㄸ","E");
	
		str = string_replace_all(str,"ㄱ","r");
		str = string_replace_all(str,"ㄲ","R");
	
		str = string_replace_all(str,"ㅅ","t");
		str = string_replace_all(str,"ㅆ","T");
	
		str = string_replace_all(str,"ㅛ","y");
	
		str = string_replace_all(str,"ㅕ","u");
	
		str = string_replace_all(str,"ㅑ","i");
	
		str = string_replace_all(str,"ㅐ","o");
		str = string_replace_all(str,"ㅒ","O");
	
		str = string_replace_all(str,"ㅔ","p");
		str = string_replace_all(str,"ㅖ","P");
	
		str = string_replace_all(str,"ㅁ","a");
	
		str = string_replace_all(str,"ㄴ","s");
	
		str = string_replace_all(str,"ㅇ","d");
	
		str = string_replace_all(str,"ㄹ","f");
	
		str = string_replace_all(str,"ㅎ","g");
	
		str = string_replace_all(str,"ㅗ","h");
	
		str = string_replace_all(str,"ㅓ","j");
	
		str = string_replace_all(str,"ㅏ","k");
	
		str = string_replace_all(str,"ㅣ","l");
	
		str = string_replace_all(str,"ㅋ","z");
	
		str = string_replace_all(str,"ㅌ","x");
	
		str = string_replace_all(str,"ㅊ","c");
	
		str = string_replace_all(str,"ㅍ","v");
	
		str = string_replace_all(str,"ㅠ","b");
	
		str = string_replace_all(str,"ㅜ","n");
	
		str = string_replace_all(str,"ㅡ","m");
